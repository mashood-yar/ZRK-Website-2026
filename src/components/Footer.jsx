    ...
    return (
        <footer className="bg-industrial-dark text-industrial-light py-16 px-6 border-t border-tundora/20">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    <h4 className="font-sans uppercase tracking-widest text-xs mb-6 text-zrk-gold">Quick Links</h4>
                    <ul className="space-y-4 text-sm font-medium">
                        <li><Link to="/e1" className="hover:text-white transition-colors">E1 Standards</Link></li>
                        <li><Link to="/sustainability" className="hover:text-white transition-colors">Sustainability</Link></li>
                        <li><Link to="/designstudio" className="hover:text-white transition-colors">Design Studio</Link></li>
            ...
            <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-tundora/20 flex flex-col md:flex-row justify-between items-center text-xs text-tundora uppercase tracking-widest gap-4 md:gap-0">
                ...
                <div className="flex items-center gap-3 bg-zrk-black/30 px-4 py-2 border border-tundora/20">
