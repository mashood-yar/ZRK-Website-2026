        ...
        <div className="w-full">
            ...
            <section className="px-6 py-12 max-w-7xl mx-auto">
                ...
                <MotionWrapper delay={0.4} yOffset={20}>
                    <div className="mt-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-tundora/20 pb-8">
                        ...
                        <Link
                            to="/products"
                            className="group flex items-center gap-4 text-sm font-sans tracking-widest uppercase text-industrial-dark dark:text-industrial-light hover:text-zrk-gold transition-colors duration-300"
                        >
                            Explore Collection
                            <ArrowRight size={20} className="transform group-hover:translate-x-2 transition-transform duration-MAX ease-industrial" />
                        </Link>
                    </div>
                </MotionWrapper>
            </section>
            ...
            <section className="px-6 py-32 bg-zrk-gold text-industrial-dark text-center relative overflow-hidden group">
                <MotionWrapper yOffset={30}>
                    ...
                    <Link
                        to="/contact"
                        className="inline-flex items-center gap-4 text-sm font-sans tracking-widest uppercase bg-industrial-dark text-industrial-light px-8 py-4 hover:bg-tundora transition-colors duration-MAX ease-industrial"
                    >
                        Contact Sales
                    </Link>
                </MotionWrapper>
